...
import CDialogAddBenefit from '../CDialogAddBenefit/CDialogAddBenefit';

type CInputBenefitProps = {
  form: any;
};

const CInputBenefit: FC<CInputBenefitProps> = ({ form }) => {
  ...
  return (
    <div className="block">
      <CDialogAddBenefit updateBenefits={updateBenefits} />
